...
.chart-box .ct{font-size:11px;letter-spacing:.2em;text-transform:uppercase;font-weight:700;
  color:var(--steel);display:flex;align-items:center;gap:10px;margin-bottom:14px}
.chart-box .ct::before{content:"";width:19px;height:3px;background:var(--orange);flex:none}
...
.chart-single .ct{font-size:11px;letter-spacing:.2em;text-transform:uppercase;font-weight:700;
  color:var(--steel);display:flex;align-items:center;gap:10px;margin-bottom:14px}
.chart-single .ct::before{content:"";width:19px;height:3px;background:var(--orange);flex:none}
